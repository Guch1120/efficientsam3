...
Request message type: std_msgs/String
...
class EfficientSam3Ros1Node:
    def __init__(self, args: argparse.Namespace) -> None:
        ...
        rospy.loginfo(
            "EfficientSAM3 ROS1 node initialized. image_topic=%s request_topic=%s output_topic=%s",
            args.input_topic,
            args.request_topic,
            args.output_topic,
        )
    ...
    def _on_request(self, req: String) -> None:
        if self.latest_rgb is None or self.latest_msg is None:
            rospy.logwarn("No image cached yet. Skip request.")
            return
